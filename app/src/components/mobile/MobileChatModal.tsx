...
export function MobileChatModal({ isOpen, onClose }: MobileChatModalProps) {
  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      const responses = [
        '根据本体推理分析，该项目在技术创新性方面表现突出，采用了最新的深度学习架构。但需要注意技术成熟度风险。',
        '通过检索相关文献，我发现类似项目在技术路线选择上存在以下常见问题：1. 过度依赖单一技术方案；2. 缺乏备选技术路线。',
        '从评审标准来看，该项目的团队配置符合要求，负责人具有丰富的研究经验。',
        '基于历史评审数据分析，该类项目的预算分配通常存在设备购置费用占比过高的问题。'
      ];
        ...
        >
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-border/50 bg-gradient-to-r from-blue-500/10 to-purple-500/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-semibold">AI评审助手</span>
